 ...
 */
public class TrainerSVM extends AbstractResource
{
    private static final long serialVersionUID = 100121900080077801L;
     ...
     * @param response
     */
    public TrainerSVM(Context context, Request request, Response response) {
    ...
    public Representation represent(Variant variant){
        ...
        builder.append(htmlHEAD);
            ...
            builder.append("<form enctype=\"application/x-www-form-urlencoded\" method=\"POST\" action=\""+
                    getRequest().getRootRef()+"/algorithm/learning/regression/svm");
            builder.append("\" >");
            builder.append("<p>Train an SVM regression model<br/>" +
