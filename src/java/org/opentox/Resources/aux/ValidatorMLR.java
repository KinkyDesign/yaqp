 ...
 */
public class ValidatorMLR extends AbstractResource{

    private static final long serialVersionUID = 10012190008005001L;

    public ValidatorMLR(Context context, Request request, Response response) {
    ...
    public Representation represent(Variant variant){
        ...
        builder.append(htmlHEAD);
            ...
            builder.append("<form enctype=\"application/x-www-form-urlencoded\" method=\"POST\" action=\""+
                    getRequest().getRootRef()+"/validation/test_set_validation/mlr");
            builder.append("\" >");
            builder.append("<h2>Validate an MLR model</h2>" +
