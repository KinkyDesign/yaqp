...
public class UploadArff extends AbstractResource{
    ...
    private static final long serialVersionUID = 10012190008006001L;
    ...
    public UploadArff(Context context, Request request, Response response) {
    ...
    public void acceptRepresentation(Representation entity) {
       ...
       if (entity != null) {
            if (MediaType.MULTIPART_FORM_DATA.equals(entity.getMediaType(), true)) {
            	...
            	logger.config("Uploading file(s) to:" + path);
                    ...
                    for (final Iterator<FileItem> it = items.iterator(); it.hasNext() && !found;) {
                        ...
                        if (fi.getFieldName().equals("file")) {
                            ...
                            if(fi.getSize() <= uploadLimit){
                            	logger.info("Checking filesize of.... "+fi.getName()+" OK!");
                            	fi.write(file);
                            	sizeFlag = true;
                            }
                            setFileName(name);
