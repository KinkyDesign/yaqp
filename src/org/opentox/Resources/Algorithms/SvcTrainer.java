            ...
            if (Status.SUCCESS_ACCEPTED.equals(internalStatus)) {
                try {
                    ...
                    if (!(modelCreated)) {
                        ...
                        org.opentox.Applications.OpenToxApplication.dbcon.registerNewModel(AbstractResource.URIs.baseURI + "/algorithm/learning/classification/svc");
                    ...
                    if (internalStatus.equals(Status.SUCCESS_OK)) {
                        ...
                        representation = new StringRepresentation(AbstractResource.URIs.mlrAlgorithmURI + "/" + model_id + "\n\n", MediaType.TEXT_PLAIN);
