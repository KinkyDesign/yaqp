    ...
    public void createModel(ModelMeta meta, OutputStream out) {
        try {
            ...
            Individual ot_model = jenaModel.createIndividual(
                    URIs.modelURI + "/" + meta.model_id, OT.Class.Model.getOntClass(jenaModel));
            ...
            Individual algorithm = jenaModel.createIndividual(
                    meta.AlgorithmURI, OT.Class.Algorithm.getOntClass(jenaModel));
            ...
            Individual dataset = jenaModel.createIndividual(meta.dataseturi.toString(), jenaModel.createOntResource(OT.Class.Dataset.getURI()));
