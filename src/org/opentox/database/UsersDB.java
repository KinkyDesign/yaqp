...
public class UsersDB implements DataBaseAccess {
    ...
    private static UsersDB instanceOfThis = null;
    public final static UsersDB INSTANCE = getInstance();

    private static UsersDB getInstance() {
        if (instanceOfThis == null) {
            instanceOfThis = new UsersDB();
        }
